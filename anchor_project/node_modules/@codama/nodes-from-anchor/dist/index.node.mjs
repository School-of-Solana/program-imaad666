...
import {
  ...
  bytesValueNode as bytesValueNode2,
...
function instructionNodeFromAnchorV00(idl, ixIndex, origin) {
  ...
  if (idl.discriminant) {
    ...
    const discriminatorField = instructionArgumentNode2({
      defaultValue: bytesValueNode2("base16", ixIndex.toString(16)),
      defaultValueStrategy: "omitted",
      name: "discriminator",
      type: fixedSizeTypeNode2(bytesTypeNode3(), 1)
    });
    dataArguments = [discriminatorField, ...dataArguments];
    discriminators = [fieldDiscriminatorNode2("discriminator")];
  }
...
import { CODAMA_ERROR__ANCHOR__ACCOUNT_TYPE_MISSING, CodamaError as CodamaError5 } from "@codama/errors";
import {
...
import { CODAMA_ERROR__ANCHOR__UNRECOGNIZED_IDL_TYPE as CODAMA_ERROR__ANCHOR__UNRECOGNIZED_IDL_TYPE3, CodamaError as CodamaError4 } from "@codama/errors";
import {
...
import { CODAMA_ERROR__ANCHOR__GENERIC_TYPE_MISSING, CodamaError as CodamaError2 } from "@codama/errors";
...
function unwrapGenericTypeFromAnchorV01(type, generics) {
  ...
  if (!genericType) {
    throw new CodamaError2(CODAMA_ERROR__ANCHOR__GENERIC_TYPE_MISSING, { name: type.defined.name });
  }
  const constArgs = {};
  const typeArgs = {};
...
import { CODAMA_ERROR__ANCHOR__UNRECOGNIZED_IDL_TYPE as CODAMA_ERROR__ANCHOR__UNRECOGNIZED_IDL_TYPE2, CodamaError as CodamaError3 } from "@codama/errors";
...
function structFieldTypeNodeFromAnchorV01(idl, generics) {
  if (!isStructField(idl)) {
    throw new CodamaError3(CODAMA_ERROR__ANCHOR__UNRECOGNIZED_IDL_TYPE2, {
...
function structTypeNodeFromAnchorV01(idl, generics) {
  ...
  return structTypeNode3(fields.map((field) => structFieldTypeNodeFromAnchorV01(field, generics)));
}
...
function tupleTypeNodeFromAnchorV01(idl, generics) {
  return tupleTypeNode2(idl.map((type) => typeNodeFromAnchorV01(type, generics)));
}

// src/v01/typeNodes/EnumTupleVariantTypeNode.ts
function enumTupleVariantTypeNodeFromAnchorV01(idl, generics) {
  return enumTupleVariantTypeNode2(idl.name ?? "", tupleTypeNodeFromAnchorV01(idl.fields, generics));
}
...
function optionTypeNodeFromAnchorV01(idl, generics) {
  ...
  return optionTypeNode2(typeNodeFromAnchorV01(item, generics), {
    fixed,
    prefix
  });
}
...
var typeNodeFromAnchorV01 = (idlType, generics) => {
  ...
  if (typeof idlType !== "object") {
    throw new CodamaError4(CODAMA_ERROR__ANCHOR__UNRECOGNIZED_IDL_TYPE3, {
      idlType: JSON.stringify(idlType)
    });
  }
  ...
  if ("defined" in idlType && typeof idlType.defined === "object") {
    return "generics" in idlType.defined ? unwrapGenericTypeFromAnchorV01(idlType, generics) : definedTypeLinkNode2(idlType.defined.name);
  }
...
function arrayTypeNodeFromAnchorV01(idl, generics) {
  if ("array" in idl) {
    ...
    return arrayTypeNode2(item2, fixedCountNode4(size));
  }
...
function accountNodeFromAnchorV01(idl, types, generics) {
  ...
  if (!type) {
    throw new CodamaError5(CODAMA_ERROR__ANCHOR__ACCOUNT_TYPE_MISSING, { name: idl.name });
  }
          ...
          switch (kind) {
            ...
            case "account": {
              ...
              if (path.length === 1) {
                ...
                if (!accountNode3) {
                  throw new CodamaError6(CODAMA_ERROR__ANCHOR__ACCOUNT_TYPE_MISSING2, { kind });
                }
                ...
                if (!fieldNode) {
                  throw new CodamaError6(CODAMA_ERROR__ANCHOR__TYPE_PATH_MISSING, {
            ...
            case "arg": {
              ...
              if (!argumentNode) {
                throw new CodamaError6(CODAMA_ERROR__ANCHOR__ARGUMENT_TYPE_MISSING, { name: seed.path });
              }
              return [
            ...
            default:
              throw new CodamaError6(CODAMA_ERROR__ANCHOR__SEED_KIND_UNIMPLEMENTED, { kind });
          }
        },
        [[], []]
      );
        ...
        switch (kind) {
          ...
          case "account": {
            ...
            if (!(programNode3 && "address" in programNode3)) {
              throw new CodamaError6(CODAMA_ERROR__ANCHOR__PROGRAM_ID_KIND_UNIMPLEMENTED, { kind });
            }
